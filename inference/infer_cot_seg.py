...
parser.add_argument("--temperature", type=float, default=1.0, help="determines the randomness of the predictions. Between 0.0 and 1.0.")
parser.add_argument("--top_p", type=float, default=0.93, help="controls the diversity of the generated audio tokens. Between 0.0 and 1.0.")
# Prompt

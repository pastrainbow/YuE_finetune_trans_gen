...
def _build_tokenizer():
    ...
    model_name_or_path = "m-a-p/YuE-s1-7B-anneal-en-icl"
    ...
    sor_token_id = _GLOBAL_TOKENIZER("[start_of_reference]")["input_ids"]
    eor_token_id = _GLOBAL_TOKENIZER("[end_of_reference]")["input_ids"]
    print(f"[DEBUG] SOR token ID: {sor_token_id}, EOR token ID: {eor_token_id}")

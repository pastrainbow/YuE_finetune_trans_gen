...
os.environ['TRANSFORMERS_CACHE'] = '/vol/bitbucket/al4624/segmented_prompt_finetune_cache/transformer_cache'
os.environ['HF_HOME'] = '/vol/bitbucket/al4624/segmented_prompt_finetune_cache/hf_home_cache'
os.environ['XDG_CACHE_HOME'] = '/vol/bitbucket/al4624/segmented_prompt_finetune_cache/xdg_cache_home'
import time
import logging
import torch
